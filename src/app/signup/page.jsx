...
export default function SignupPage() {
  ...
  return (
    <div className="flex justify-center items-center mt-8 sm:px-4">
      <form
      ...
      >
        ...
        <button
          type="submit"
          className="w-full py-2 rounded-lg text-white font-semibold cursor-pointer bg-linear-to-r from-[#0b1a33] via-[#1e3a8a] to-[#5b21b6] shadow-md hover:opacity-90 transition"
        >
